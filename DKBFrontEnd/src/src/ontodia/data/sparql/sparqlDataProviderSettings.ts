...
`,
    ...
    classTreeQuery: `
            SELECT distinct ?class ?label ?parent WHERE { __GRAPH_LIMIT_BEGIN__
...
`,
    ...
    elementInfoQuery: `
            ...
            __GRAPH_LIMIT_END__ } VALUES (?inst) {\${ids}}
        `,
    ...
    linkTypesOfQuery: `
        ...
        __GRAPH_LIMIT_END__ } GROUP BY ?link
    `,
    ...
    classTreeQuery: `
        ...
        WHERE { __GRAPH_LIMIT_BEGIN__
            {SELECT ?class (count(?inst) as ?instcount)
                WHERE { __GRAPH_LIMIT_BEGIN__
                    ?inst rdf:type ?class.
                __GRAPH_LIMIT_END__ } GROUP BY ?class } UNION
            {
